...
public class Ball {
    ...
    */
   public void moveOneStepWithCollisionDetection(int windowMinX,int windowMinY,int windowMaxX,int windowMaxY) {
      // Get the ball's bounds, offset by the radius of the ball
      float ballMinX = windowMinX + radius;
      float ballMinY = windowMinY + radius;
      float ballMaxX = windowMaxX - radius;
      float ballMaxY = windowMaxY - radius;
