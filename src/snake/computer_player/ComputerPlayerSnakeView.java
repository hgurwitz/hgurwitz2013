...
public class ComputerPlayerSnakeView extends JComponent {

	private static final long serialVersionUID = 1L;
	private ComputerPlayerGameController controller;
	public static final int PIECELENGTH = 20;
	public static final int SIDELENGTH = (PIECELENGTH * BodyPiece.SIZE);

	public ComputerPlayerSnakeView(ComputerPlayerGameController controller) {
		super();
